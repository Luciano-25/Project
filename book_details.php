...
// Fetch reviews
$reviews_stmt = $conn->prepare("SELECT r.*, u.username FROM review r JOIN orders o ON r.order_id = o.id JOIN users u ON r.user_id = u.id WHERE o.book_id = ? ORDER BY r.created_at DESC");
